...
**organisatie-a-fsc-peer** — de **FSC provider-peer** van Organisatie A, die de dienst
`berichtenmagazijn` (magazijn-a) aanbiedt en zich aansluit op de gedeelde FSC-testfederatie van
...
- **Gerelateerd:** [moza-fsc-testnet](https://github.com/MinBZK/moza-fsc-testnet) (infra + directory),
  [moza-poc-fbs-berichtenbox](https://github.com/MinBZK/moza-poc-fbs-berichtenbox) (de magazijn-app).
- Deze repo bevat **uitsluitend FSC-infra** (PKI + deploy) voor één peer, niet de magazijn-applicatie.
...
| Parameter | Waarde |
|-----------|--------|
| Peer-naam | `magazijn-a` (functioneel "Organisatie A") |
| Peer-OIN = Peer ID (`subject.serialNumber`) | `00000001003214345000` |
